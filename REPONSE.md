...
1. Donnée stats incohérent
  ...
  - Correction: 
    * on a deux corrections à faire, créer une variable globale pour que chaque api de traitement de message ait accès au changement de données
    * faire une écriture sur le `message.json` pour le mettre à jour
